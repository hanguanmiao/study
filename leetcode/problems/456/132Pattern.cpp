...
//    cout << s.find132pattern(input) << endl; // false

    input = vector<int>({3,1,4,2});
    cout << s.find132pattern(input) << endl; // true

    input = vector<int>({-1,3,2,0});
    cout << s.find132pattern(input) << endl; // true

    input = vector<int>({-2,1,1,-2,1,1});
    cout << s.find132pattern(input) << endl; // false

    input = vector<int>({3,5,4,6,1});
    cout << s.find132pattern(input) << endl; // true
