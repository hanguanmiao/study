...
#line 78 "pmysql.tab.c" /* yacc.c:339  */
...
#line 365 "pmysql.tab.c" /* yacc.c:355  */
};
...
#line 382 "pmysql.tab.c" /* yacc.c:358  */
...
static const char *const yytname[] =
{
  ...
  "SHIFT", "'+'", "'-'", "'*'", "'/'", "'%'", "MOD", "'^'", "UMINUS",
  "ADD", "ALL", "ALTER", "ANALIZE", "AND", "ANY", "AS", "ASC",
  ...
  "DELCARE", "DEFAULT", "DELAYED", "DELETE", "DESC", "DESCRIBE",
  ...
  "INTEGER", "INTERVAL", "INTO", "INERATE", "JOIN", "KEY", "KEYS", "KILL",
  ...
  "FDATE_ADD", "FDATE_SUB", "FCOUNT", "$accept", "expr", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 103 "pmysql.y" /* yacc.c:1646  */
    {emit("NAME %s", (yyvsp[0].strval)); free((yyvsp[0].strval));}
#line 1532 "pmysql.tab.c" /* yacc.c:1646  */
    break;


#line 1536 "pmysql.tab.c" /* yacc.c:1646  */
      default: break;
    }
